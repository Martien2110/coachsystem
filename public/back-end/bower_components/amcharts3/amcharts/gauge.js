            ...
            if (t)
                for (var q = 0; q < t.length; q++) {
                    ...
                    if (n) {
                        var x = n.startValue,
                            B = n.endValue,
                            l = c.toCoordinate(n.radius, y);
                        isNaN(l) && (l = F);
                        var w = c.toCoordinate(n.innerRadius, y);
                        isNaN(w) && (w = l - H);
                        var J = u + f * (x - this.startValue),
                            B = f * (B - x),
                            A = n.outlineColor;
                        void 0 == A && (A = this.bandOutlineColor);
                        var K = n.outlineThickness;
                        ...
                        n.url && (A.cursor = "pointer");
                        l = c.wedge(p, C, D, J, B, l, l, w, 0, A);
                        c.setCN(a, l.wedge, "axis-band");
                        void 0 !== n.id && c.setCN(a, l.wedge, "axis-band-" + n.id);
                        l.setAttr("opacity", x);
                        this.set.push(l);
                        this.addEventListeners(l, n)
                    }
                }
            f = this.axisThickness / 2;
            k = c.wedge(p, C, D, u, k - u, r + f, r + f, r - f, 0, z);
    ...
    c.AmAngularGauge = c.Class({
        ...
        drawChart: function() {
            ...
            var d = c.toCoordinate,
                ...
                u = d(this.marginTop, e) + this.getTitleHeight(),
                k = d(this.marginBottom, e),
                h = d(this.radius, b, e),
                d = b - g - m,
                v = e - u - k + this.extraHeight;
            h || (h = Math.min(d, v) / 2);
            h < this.minRadius && (h = this.minRadius);
            this.radiusReal = h;
            this.centerX = (b - g - m) / 2 + g;
            this.centerY = (e - u - k) / 2 + u + this.extraHeight /
                2;
            ...
            for (b = h = a = 0; b < this.axes.length; b++) e = this.axes[b], g = e.radius, e.radiusReal = c.toCoordinate(g, this.radiusReal), e.draw(), m = 1, -1 !== String(g).indexOf("%") && (m = 1 + (100 - Number(g.substr(0,
                g.length - 1))) / 100), e.width * m > a && (a = e.width * m), e.height * m > h && (h = e.height * m);
            ...
            if (this.adjustSize && !this.sizeAdjusted) {
                ...
                f = 0;
                if (v > h || d > a) f = Math.min(v - h, d - a);
                0 < f && (this.extraHeight = v - h, this.sizeAdjusted = !0, this.validateNow())
            }
            d = this.arrows.length;
            for (b = 0; b < d; b++) v = this.arrows[b], v.drawnAngle = NaN;
            this.dispDUpd()
        },
        ...
        drawArrow: function(a, b) {
            ...
            if (!a.hidden) {
                ...
                var G = a.nailColor;
                G || (G = a.color);
                0 < a.nailRadius && (p = c.circle(e, a.nailRadius, p, a.nailAlpha, a.nailBorderThickness, p, a.nailBorderAlpha), c.setCN(this, p, "gauge-arrow-nail"), a.set.push(p), p.translate(m, u));
                ...
                var d = Math.sin(b / 180 * Math.PI),
                    ...
                    e = c.polygon(e, [m - k / 2 * p + v * d, m + f * d - h / 2 * p, m + f * d + h / 2 * p, m + k / 2 * p + v * d], [u + k / 2 * E - v * g, u - f * g + h / 2 * E,
                        u - f * g - h / 2 * E, u - k / 2 * E - v * g
