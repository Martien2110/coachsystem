...
(function() {
    ...
    d.easeOutElastic = function(a, b, c, e, d) {
        ...
        if (1 == (b /= d)) return c + e;
        f || (f = .3 * d);
        g < Math.abs(e) ? (g = e, a = f / 4) : a = f / (2 * Math.PI) * Math.asin(e /
            g);
    ...
    d.AxisBase = d.Class({
        ...
        parseDatesDraw: function() {
            ...
            if (0 < this.gridCountR)
                for (A - 5 - k >
                    this.autoRotateCount && !isNaN(this.autoRotateAngle) && (this.labelRotationR = this.autoRotateAngle), a = k; a <= A; a++) {
                    ...
                    if ("radar" == b.type) {
                        ...
                        (J = -z * this.stepWidth / 2) : "date" == this.type && (h = this.axisWidth - h);
                    f = !1;
                    ...
                    m = l = p;
                    if (!isNaN(u))
                        for (h = 1; h < w; h += u) this.gridAlpha = this.minorGridAlpha, f = p + x * h, f = d.resetDateToMin(new Date(f), B, u, t).getTime(), f = new this.axisItemRenderer(this, (f - this.startTime) * this.stepWidth, void 0, void 0, void 0, void 0, void 0, void 0, void 0, !0), this.pushAxisItem(f);
                    this.gridAlpha = y
                }
        },
        ...
        setBalloonBounds: function() {
            ...
            if (a) {
                ...
                if (this.parseDates || "date" == this.type) a.pointerWidth =
                    0;
                b = "V";
    ...
    d.ValueAxis = d.Class({
        ...
        updateData: function() {
            ...
            "xy" != a.type && (this.stackGraphs("smoothedLine"),
                this.stackGraphs("line"), this.stackGraphs("column"), this.stackGraphs("step"));
            ...
            this.synchronizationMultiplier && this.synchronizeWith ? (d.isString(this.synchronizeWith) && (this.synchronizeWith = a.getValueAxisById(this.synchronizeWith)), this.synchronizeWith && (this.synchronizeWithAxis(this.synchronizeWith), this.foundGraphs = !0)) : (this.foundGraphs = !1, this.getMinMax(), 0 === this.start && this.end == this.data.length - 1 && isNaN(this.minZoom) && isNaN(this.maxZoom) && (this.fullMin =
                this.min, this.fullMax = this.max, "date" != this.type && (isNaN(this.minimum) || (this.fullMin = this.minimum), isNaN(this.maximum) || (this.fullMax = this.maximum)), this.logarithmic && (this.fullMin = this.logMin, 0 === this.fullMin && (this.fullMin = this.treatZeroAs)), "date" == this.type && (this.minimumDate || (this.fullMin = this.minRR), this.maximumDate || (this.fullMax = this.maxRR))))
        },
        draw: function() {
            ...
            if (isNaN(this.min) || isNaN(this.max) || !this.foundGraphs || Infinity == this.min || -Infinity == this.max) e = !0;
                ...
                } else this.relativeStart = d.fitToBounds((this.min - this.fullMin) / (this.fullMax - this.fullMin), 0, 1), this.relativeEnd =
                ...
                if (0 < B) {
                    ...
                    for (g = this.fillAlpha = 0; g < B; g++) {
                        ...
                        isNaN(A.toValue) || (C = this.getCoordinate(A.toValue),
                            x = new this.axisItemRenderer(this, C, "", !0, NaN, NaN, A), this.pushAxisItem(x, D));
                        var J = NaN;
                ...
                this.exponential = !1;
                for (g = f; g < t; g += p) w = d.roundTo(this.step * g + this.min, y), -1 != String(w).indexOf("e") &&
                    (this.exponential = !0);
                ...
                if (this.autoGridCount || 0 !== this.gridCount)
                    if ("date" == c) this.generateDFObject(), this.timeDifference = this.max - this.min, this.maxTime = this.lastTime = this.max, this.startTime = this.firstTime = this.min, this.parseDatesDraw();
                        ...
                        for (t >= this.autoRotateCount && !isNaN(this.autoRotateAngle) && (this.labelRotationR =
                                this.autoRotateAngle), h && t++, g = f; g < t; g += p)
                            if (c = y * g + this.minCalc, c = d.roundTo(c, this.maxDecCount + 1), !this.integersOnly || Math.round(c) == c)
        ...
        formatValue: function(a, b, c) {
            var e = this.exponential,
                ...
                g = this.chart;
            if (f) return !0 === this.logarithmic && (e = -1 != String(a).indexOf("e") ? !0 : !1), this.useScientificNotation && (e = !0), this.usePrefixes && (e = !1), e ? (c = -1 == String(a).indexOf("e") ?
                ...
                f)), "date" == this.type && (c = d.formatDate(new Date(a), this.currentDateFormat, g)), this.recalculateToPercents ? c += "%" : (b = this.unit) && (c = "left" == this.unitPosition ? b + c : c + b), this.labelFunction && (c = "date" == this.type ? this.labelFunction(c, new Date(a), this).toString() : this.labelFunction(a, c, this).toString()), c
        },
        ...
        stackGraphs: function(a) {
            ...
            if (r && ("regular" == b || "100%" == b))
                for (q = 0; q < k.length; q++) n = k[q], n.stackGraph = null, n.hidden || (m = n.type, n.chart == this.chart && n.valueAxis ==
                    this && a == m && n.stackable && (l && (n.stackGraph = l), l = n));
            n = this.start - 10;
            l = this.end + 10;
                ...
                for (q = 0; q < k.length; q++)
                    ...
                    if (m = this.data[p].axes[this.id].graphs[n.id], g = m.values.value, isNaN(g)) n.newStack && (h[p] = NaN, e[p] = NaN);
                        ...
                        "regular" == b && (r && (isNaN(c[p]) ? (c[p] = g, m.values.close = g, m.values.open = this.baseValue) : (isNaN(g) ? m.values.close = c[p] : m.values.close = g + c[p], m.values.open = c[p], c[p] = m.values.close)), "column" == a && (n.newStack && (h[p] = NaN, e[p] = NaN), m.values.close = g, 0 > g ? (m.values.close = g, isNaN(e[p]) ? m.values.open = t : (m.values.close += e[p], m.values.open = e[p]), e[p] = m.values.close) : (m.values.close =
                            g, isNaN(h[p]) ? m.values.open = t : (m.values.close += h[p], m.values.open = h[p]), h[p] = m.values.close)))
                    }
            }
            for (p = this.start; p <= this.end; p++)
                for (q = 0; q < k.length; q++)(n = k[q], n.hidden) ? n.newStack && (h[p] = NaN, e[p] = NaN) : (m = n.type, n.chart == this.chart && n.valueAxis == this && a == m && n.stackable && (m = this.data[p].axes[this.id].graphs[n.id], g = m.values.value, isNaN(g) || (c = g / f[p] * 100, m.values.percents = c, m.values.total = f[p], n.newStack && (h[p] = NaN, e[p] = NaN), "100%" == b && (isNaN(e[p]) && (e[p] = 0), isNaN(h[p]) && (h[p] = 0), 0 > c ? (m.values.close =
                    d.fitToBounds(c + e[p], -100, 100), m.values.open = e[p], e[p] = m.values.close) : (m.values.close = d.fitToBounds(c + h[p], -100, 100), m.values.open = h[p], h[p] = m.values.close)))))
        },
        ...
        getMinMax: function() {
            ...
            b = this.max;
            c = this.max - this.min;
            e = 0 === c ? Math.pow(10, Math.floor(Math.log(Math.abs(this.max)) *
                Math.LOG10E)) / 10 : Math.pow(10, Math.floor(Math.log(Math.abs(c)) * Math.LOG10E)) / 10;
            ...
            this.logarithmic && (2 < Math.log(b) * Math.LOG10E - Math.log(a) * Math.LOG10E ? (this.minReal = this.min = Math.pow(10, Math.floor(Math.log(Math.abs(a)) * Math.LOG10E)), this.max = Math.pow(10, Math.ceil(Math.log(Math.abs(b)) *
                Math.LOG10E))) : (a = Math.pow(10, Math.floor(Math.log(Math.abs(a)) * Math.LOG10E)) / 10, Math.pow(10, Math.floor(Math.log(Math.abs(this.min)) * Math.LOG10E)) / 10 < a && (this.minReal = this.min = 10 * a)))
        },
    ...
    d.RecItem = d.Class({
        construct: function(a, b, c, e, h, f, g, k, l, m, n, q) {
            ...
            var ia = a.counter,
                ...
                da = a.offset,
                fa, za;
            g ? (void 0 !== g.id && (q = p.classNamePrefix + "-guide-" + g.id), P = !0, isNaN(g.tickLength) || (A = g.tickLength), void 0 != g.lineColor && (J = g.lineColor), void 0 != g.color && (u = g.color), isNaN(g.lineAlpha) || (C = g.lineAlpha), isNaN(g.dashLength) || (H = g.dashLength), isNaN(g.lineThickness) || (D = g.lineThickness), !0 === g.inside && (I = !0, 0 < da && (da = 0)), isNaN(g.labelRotation) ||
                (n = g.labelRotation), isNaN(g.fontSize) || (r = g.fontSize), g.position && (ea = g.position), void 0 !== g.boldLabel && (k = g.boldLabel), isNaN(g.labelOffset) || (Z = g.labelOffset)) : "" === c && (A = 0);
            ...
            if ("H" == Oa) {
                ...
                v += r / 2;
                "right" == ea ? (G +=
                    va + ya + da, v += la, I ? (f || (v -= r / 2 + 3), G = G - (A + 4) - Z) : (G += A + 4 + w, v -= 2, G += Z)) : I ? (G += A + 4 - da, f || (v -= r / 2 + 3), g && (G += va, v += la), G += Z) : (G += -A - w - 4 - 2 - da, v -= 2, G -= Z);
    ...
    d.AmChart = d.Class({
            ...
            if (d.ifArray(b)) {
                ...
                for (e = 0; e < b.length; e++) {
                    ...
                    if (!1 !== h.enabled) {
                        ...
                        f = d.wrappedText(this.container, h.text, f, this.fontFamily,
                            g, "middle", l, this.realWidth - 35);
        ...
        measure: function() {
            ...
            if (a) {
                ...
                a = f.width;
                f = f.height; -
                1 != a.indexOf("px") && (c = d.removePx(a)); - 1 != f.indexOf("px") && (e = d.removePx(f));
                e = Math.round(e);
                c = Math.round(c);
    ...
    d.AmGraph = d.Class({
        ...
        draw: function() {
            ...
            if (a.drawGraphs) {
                ...
                d.ifArray(this.data) && (a = !1, "xy" == b ? this.xAxis.axisCreated && this.yAxis.axisCreated && (a = !0) : this.valueAxis.axisCreated && (a = !0), !this.hidden &&
                    a && this.createGraph());
                e.push(c)
            }
        },
        createGraph: function() {
            ...
            if (!isNaN(a.valueAxis.min) &&
                !isNaN(a.valueAxis.max)) {
                switch (c) {
                    case "serial":
        ...
        createSerialGraph: function() {
            ...
            this.nmh = La(ub);
            this.nmw = La(vb);
            d.isModern || (this.nmy = this.nmx = 0, this.nmh =
                this.height);
            this.clustered || (r = 1);
            ...
            if ("line" == g || "step" == g || "smoothedLine" == g) {
                if (0 < P) {
                    for (M = P - 1; - 1 < M; M--)
                        if (G = e[M], v = G.axes[f.id].graphs[b], ma = v.values.value, !isNaN(ma)) {
                            P = M;
                            break
                        }
                    if (this.lineColorField)
                        for (M = P; - 1 < M; M--)
                            if (G = e[M], v = G.axes[f.id].graphs[b], v.lineColor) {
                                this.bulletColorSwitched = this.lineColorSwitched = v.lineColor;
                                break
                            }
                    if (this.fillColorsField)
                        for (M = P; - 1 < M; M--)
                            if (G = e[M], v = G.axes[f.id].graphs[b],
                                v.fillColors) {
                    ...
                    if (this.dashLengthField)
                        for (M = P; - 1 < M; M--)
                            if (G = e[M], v = G.axes[f.id].graphs[b], !isNaN(v.dashLength)) {
            ...
            var U = [],
                ...
                Ra = !1;
            if ("line" == g || "step" == g || "smoothedLine" == g)
                if (this.stackable && "regular" == L || "100%" == L || this.fillToGraph) Ra = !0;
            ...
            for (M = P; M <= ia; M++) {
                ...
                if (m && void 0 == this.openField)
                    for (var Ab = M + 1; Ab < e.length && (!e[Ab] || !(ab = e[M + 1].axes[f.id].graphs[b]) || !ab.values || (Ta = ab.values.value, isNaN(Ta))); Ab++);
                var S, Q, K, aa, na = NaN,
                    E = NaN,
                    F = NaN,
                    O = NaN,
                ...
                if (Ia) {
                    ...
                    m && (void 0 == this.openField ? ab && (ab.isNegative = Ta < W ? !0 :
                        !1, isNaN(Ta) && (v.isNegative = !Sa)) : v.isNegative = Ta > W ? !0 : !1);
                    ...
                    "start" == this.pointPosition && (na -= Y / 2 + Math.floor(Wa * Y / 2), xa = 0, Ga = Math.floor(Y) +
                        Math.floor(Wa * Y));
                    ...
                    $a = !1;
                    isNaN(W) || (m ? W > Ta ? (Sa && ($a = !0), Sa = !1) : (Sa || ($a = !0), Sa = !0) : v.isNegative = W < Oa ?
                        !0 : !1, za = W);
                    var Qb = !1;
                    ...
                    switch (g) {
                        case "line":
                            if (isNaN(W)) y || (this.drawLineGraph(x, w, U, V), x = [], w = [], U = [], V = []);
                                ...
                                if ($a || void 0 != v.lineColor && v.lineColor != this.lineColorSwitched || void 0 != v.fillColors && v.fillColors != this.fillColorsSwitched || !isNaN(v.dashLength)) this.drawLineGraph(x,
                                    w, U, V), x = [E], w = [F], U = [], V = [], !Ra || isNaN(N) || isNaN(O) || (U.push(O), V.push(N)), m ? Sa ? (this.lineColorSwitched = ya, this.fillColorsSwitched = wb) : (this.lineColorSwitched = Ja, this.fillColorsSwitched = Qa) : (this.lineColorSwitched = v.lineColor, this.fillColorsSwitched = v.fillColors), this.dashLengthSwitched = v.dashLength;
                        ...
                        case "step":
                            if (!isNaN(W)) {
                                t ? (isNaN(B) || (x.push(B), w.push(F - xa)), w.push(F -
                                    xa), x.push(E), w.push(F + Ga), x.push(E), !Ra || isNaN(N) || isNaN(O) || (isNaN(A) || (U.push(A), V.push(N - xa)), U.push(O), V.push(N - xa), U.push(O), V.push(N + Ga))) : (isNaN(z) || (w.push(z), x.push(E - xa)), x.push(E - xa), w.push(F), x.push(E + Ga), w.push(F), !Ra || isNaN(N) || isNaN(O) || (isNaN(C) || (U.push(O - xa), V.push(C)), U.push(O - xa), V.push(N), U.push(O + Ga), V.push(N)));
                                B = E;
                                z = F;
                                A = O;
                                C = N;
                            ...
                            if (!isNaN(W)) {
                                ...
                                if (ua) {
                                    ...
                                    if (!I) {
                                        ...
                                        "3d" == L && (t ? (J = (this.end + 1 - M) * D - c - 1E3 * this.depthCount, wa += H * this.columnIndex, ja += H * this.columnIndex, v.y += H * this.columnIndex) : (J = (D - c) * (M + 1) + 1E3 * this.depthCount, Da += R * this.columnIndex, ka += R * this.columnIndex,
                            ...
                            if (!isNaN(ta) && !isNaN(W)) {
                                ...
                                if (t) {
                                    ...
                                    if (S < n && 0 < K) {
                                        ...
                                        !isNaN(sa) && !isNaN(qa) && E < n && 0 < E && (Xa = d.line(h, [E, E], Hb, Aa, X, ca), cb = d.line(h, [E, E], Ib, Aa, X, ca), d.setCN(a, Xa,
                                            this.bcn + "line-high"), v.className && d.setCN(a, Xa, v.className, !0), d.setCN(a, cb, this.bcn + "line-low"), v.className && d.setCN(a, cb, v.className, !0))
                                    }
                                }
        ...
        drawLineGraph: function(a, b, c, e) {
            ...
            if (1 < a.length) {
                ...
                if (0 < g || 0 < B)
                    if (p = a.join(";").split(";"), r = b.join(";").split(";"), q = k.type, "serial" == q || "radar" == q ? 0 < c.length ? (c.reverse(),
        ...
        drawSmoothedGraph: function(a, b, c, e) {
            if (1 < a.length) {
                ...
                0 < q && (m = a.join(";").split(";"), p = b.join(";").split(";"), n = "", 0 < c.length ?
        ...
        animateGraphs: function() {
            ...
            var f = a.startDuration,
                g = a.startEffect;
            b &&
                (this.rotate ? (b.translate(-1E3, d), c.translate(-1E3, d)) : (b.translate(e, -1E3), c.translate(e, -1E3)), b.animate({
                    opacity: 1,
                    translate: e + "," + d
                }, f, g), c.animate({
                    opacity: 1,
        ...
        legendKeyColor: function() {
            var a = this.legendColor,
                b = this.lineAlpha;
            void 0 ===
                a && (a = this.lineColorR, 0 === b && (b = this.fillColorsR) && (a = "object" == typeof b ? b[0] : b));
            return a
        },
        ...
        fixBulletSize: function() {
            if (d.isModern) {
                ...
                if (a) {
                    ...
                    b && !b.doNotScale &&
                        (b.translate(a.bx, a.by, 1), b.setAttr("fill-opacity", this.bulletAlpha), b.setAttr("stroke-opacity", this.bulletBorderAlpha))
                }
        ...
        showGraphBalloon: function(a, b, c, e, h) {
            ...
            if (g && g.enabled && this.showBalloon && !this.hidden) {
                var m = f.formatString(this.balloonText,
                        a, !0),
...
(function() {
    ...
    d.ChartCursor = d.Class({
        ...
        updateFullLine: function() {
            this.zooming && this.fullWidth && this.selection && (this.rotate ? 0 < this.selection.height && this.hhLine.hide() : 0 < this.selection.width &&
                this.vvLine.hide())
        },
        updateSelection: function() {
            if (!this.pan) {
                ...
                isNaN(this.mouse2X) && 0 < Math.abs(h) && 0 < Math.abs(f) && (a = this.chart, b = d.rect(this.container, h, f, this.cursorColor, this.selectionAlpha),
                    d.setCN(a, b, "cursor-selection"), b.width = h, b.height = f, b.translate(c, e), this.set.push(b), this.selection = b);
                this.updateFullLine()
            }
        },
        ...
        handleReleaseOutside: function() {
            ...
            this.zooming && (this.zooming = !1, this.selectWithoutZooming ?
                this.dispatchZoomEvent("selected") : (this.hZoomEnabled || this.vZoomEnabled) && this.dispatchZoomEvent("zoomed"), this.rolledOver && this.dispatchMovedEvent(this.mouseX, this.mouseY));
            ...
            if (!this.pan) {
                ...
                if (b && 3 < Math.abs(b.width) && 3 < Math.abs(b.height)) {
                    ...
                    l && l.parseDates && !l.equalSpacing &&
                        (d = k[c] ? k[c].time : Math.min(this.timestamp0, this.timestamp), f = k[e] ? g.getEndTime(k[e].time) : Math.max(this.timestamp0, this.timestamp));
                    var b = {
                            type: a,
                            chart: this.chart,
                            target: this,
    ...
    d.SimpleChartScrollbar = d.Class({
        ...
        update: function() {
            ...
            if (k) {
                ...
                n.mouseIsOver && (this.dragging && (n = this.initialCoord, m ? (a = n + (r - a), 0 > a && (a = 0), n = p - k, a > n && (a = n), g.setAttr("y", a)) : (a = n + (t - a), 0 > a && (a = 0), n = q - l, a > n && (a = n), g.setAttr("x", a)), this.clipDragger(!0)), this.resizingRight && (m ? (a = r - e, a + e > p + f && (a = p - e + f), 0 > a ? (this.resizingRight = !1,
                    ...
                    g.setAttr("x", c + l - d)) : (0 === a && (a = .1), g.setAttr("x", e - d), g.setAttr("width", a))), this.clipDragger(!0)))
            }
        },
        ...
        dispatchScrollbarEvent: function() {
            if (this.skipEvent) this.skipEvent = !1;
                ...
                var b = this.getDBox(),
                    ...
                    f = b.height,
                    g, k;
                this.rotate ? (b = d, g = this.height / f, k = 1 - d / this.height, c = 1 - (d + f) / this.height) : (b = c, g = this.width /
                    h, k = c / this.width, c = (c + h) / this.width);
                this.fire({
                    type: "zoomed",
                    position: b,
                    chart: a,
        ...
        percentZoom: function(a, b) {
            if (this.dragger && this.enabled) {
                ...
                var c, d, h;
                this.rotate ?
                    (c = this.height, d = c - c * b, h = c - c * a) : (c = this.width, h = c * b, d = c * a);
        ...
        handleDragStart: function() {
            if (this.enabled) {
                ...
                this.dragging = !0;
                var b = this.getDBox();
                this.rotate ? (this.initialCoord = b.y, this.initialMouse = a.mouseY) :
    ...
    d.ChartScrollbar = d.Class({
        ...
        dispatchScrollbarEvent: function() {
            if ("ValueAxis" == this.categoryAxis.cname) d.ChartScrollbar.base.dispatchScrollbarEvent.call(this);
                ...
                } else if (k.startOnAxis || (b += l / 2), c -= this.stepWidth / 2, h = k.xToIndex(b), b = k.xToIndex(b + c), h != this.start || this.end != b) k.startOnAxis &&
                    (this.resizingRight && h == b && b++, this.resizingLeft && h == b && (0 < h ? h-- : b = 1)), this.start = h, this.end = this.dragging ? this.start + this.difference : b, f.start = this.start, f.end = this.end, k.parseDates && (a[this.start] && (f.startDate = new Date(a[this.start].time)), a[this.end] && (f.endDate = new Date(a[this.end].time))), this.fire(f);
        ...
        draw: function() {
            ...
            if (!isNaN(a)) {
                ...
                if (this.show) {
                    ...
                    this.drop ? (g = D / 1.6, l = 0, "V" == x && (x = "down"), "H" == x && (x = "left"), "down" == x && (C = a + 1, z = b - g - g / 3), "up" == x && (l = 180, C = a + 1, z = b + g + g / 3), "left" == x && (l = 270, C = a + g + g / 3 + 2, z = b), "right" == x && (l = 90, C = a - g - g / 3 + 2, z = b), k = z - H / 2 + 1, m = C - J / 2 - 1, q = d.drop(h, g, l, q, u, r, p, Z)) : 0 < w || 0 === y ? (0 < L && (a = d.rect(h, D, B, q, 0, r + 1,
    ...
    d.AmCoordinateChart = d.Class({
        ...
        parsePartSerialData: function(a, b, c, e) {
            ...
            if (this.parseCount == e) {
                for (a = 0; a < h.length; a++) b =
                    h[a], b.dataProvider && this.parseGraphData(b);
                this.dataChanged = !1;
        ...
        chooseGraphColor: function(a, b) {
            if (a.lineColor) a.lineColorR = a.lineColor;
                ...
                var c;
                c = this.colors.length > b ? this.colors[b] : a.lineColorR ?
                    a.lineColorR : d.randomColor();
                a.lineColorR = c
            }
...
(function() {
    ...
    d.wedge = function(a, b, c, e, h, f, g, k, l, m, n, q, p, t) {
        ...
        if (0 < l) {
            P = " M" + x + "," + (B + l) + " L" + z + "," + (A + l);
            y ? (L || (P += " A" + (b - f) + "," + (l + c - g) + "," + (b + f) + "," + (l + c + g) + "," + z + "," + (A + l) + "," + C + "," + (D + l)), P += " L" + J + "," + (w + l), 0 < k && (L || (P += " B" + (b - k) + "," + (l + c - u) + "," + (b + k) + "," +
                (l + c + u) + "," + J + "," + (l + w) + "," + x + "," + (l + B)))) : (P += " A" + f + "," + g + ",0," + R + ",1," + C + "," + (D + l) + " L" + J + "," + (w + l), 0 < k && (P += " A" + k + "," + u + ",0," + R + ",0," + x + "," + (B + l)));
            P += " Z";
            var ia = l;
            y && (ia /= 10);
            ...
            l = a.path(" M" + C + "," + D + " L" + C + "," + (D + l) + " L" + J + "," + (w + l) + " L" + J + "," + w + " L" + C + "," + D + " Z", void 0, void 0,
                "1000,1000").attr(H);
            e.push(P);
            e.push(l)
        }
        ...
        createEntry: function(a) {
            if (!1 !== a.visibleInLegend && !a.hideFromLegend) {
                ...
                if (this.useGraphSettings) {
                    ...
                    if ("line" == c || "step" == c || "smoothedLine" == c || "ohlc" == c) g = l.set(), a.hidden || (e = a.lineColorR, f = a.bulletBorderColorR), n = d.line(l, [0, 2 * m], [m / 2, m / 2], e, a.lineAlpha, a.lineThickness, a.dashLength), d.setCN(b, n, "graph-stroke"), g.push(n), a.bullet && (a.hidden ||
                        (e = a.bulletColorR), n = d.bullet(l, a.bullet, a.bulletSize, e, a.bulletAlpha, a.bulletBorderThickness, f, a.bulletBorderAlpha)) && (d.setCN(b, n, "graph-bullet"), n.translate(m + 1, m / 2), g.push(n)), p = 0, n = m, q = m / 3;
                    else {
                        var t;
                ...
                (f = this.switchType) && "none" != f && 0 < m && ("x" == f ? (t = this.createX(), t.translate(m / 2, m / 2)) : t = this.createV(), t.dItem = a, !0 !== a.hidden ? "x" == f ? t.hide() : t.show() :
                    "x" != f && t.hide(), this.switchable || t.hide(), this.addListeners(t, a), a.legendSwitch = t, l.push(t), d.setCN(b, t, "legend-switch"));
                f = this.color;
                ...
                e && (e = d.fixBrakes(e), a.legendTextReal =
                    e, u = this.labelWidth, u = isNaN(u) ? d.text(this.container, e, f, b.fontFamily, t, "start") : d.wrappedText(this.container, e, f, b.fontFamily, t, "start", !1, u, 0), d.setCN(b, u, "legend-label"), u.translate(this.lx + n, this.ly), l.push(u), b = u.getBBox().width, this.maxLabelWidth < b && (this.maxLabelWidth = b));
